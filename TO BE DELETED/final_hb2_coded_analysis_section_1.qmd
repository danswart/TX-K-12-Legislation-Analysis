---
title: "Texas HB2: ARTICLE 1. TEACHER COMPENSATION - Incentives and Likely Results"
...
enhanced_likely_results <- data.frame(
  Category = c(
    ...
    "Educator Preparation Restrictions",
    "Uncertified Teacher Employment",
    "Innovation District Limitations"
  ),
  ...
  Incentive_Created = c(
    ...
    "Innovation districts cannot exempt themselves from employment of uncertified classroom teachers prohibition",
    "Districts may employ uncertified teachers only with commissioner-approved plan and timeline",
    "Innovation districts limited in exemptions from state curriculum and teacher certification requirements"
  ),
  ...
  Intended_Consequence = c(
    ...
    "Innovation districts maintain teacher quality standards while preserving flexibility",
    "Districts can address teacher shortages while maintaining pathway to certification",
    "Innovation districts balance autonomy with state accountability for teacher preparation"
  ),
  ...
  Likely_Result = c(
    ...
    "G, L", # Innovation limitations: reduced local control, bureaucracy
    "C, G, I", # Uncertified teacher plans: force from state, reduced local control, system tampering
    "G, I, L" # Innovation district restrictions: reduced local control, system tampering, bureaucracy
  )
)
  ...
  formatStyle(
    ...
    backgroundColor = styleEqual(
      c("Teacher Designation System - Enhanced", "Teacher Incentive Allotment", "Enhanced System Bonuses", 
        ...
        "Educator Preparation Restrictions", "Uncertified Teacher Employment", "Innovation District Limitations"),
      c('#E8F4FD', '#E8F6FF', '#FFF2CC', '#E8F5E8', '#F0E8FF', '#FFE8F5', '#FFE8E8', '#FFD0D0',
        '#E0F0FF', '#F5F5DC', '#FFE0B2', '#E8E8E8', '#F0F8FF', '#FFFACD', '#F5F5F5')
    ),
    fontWeight = 'bold'
  ) %>%
  formatStyle(
