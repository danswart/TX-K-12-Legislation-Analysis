---
title: "Texas HB2 Sections 1-5: Incentives and Likely Results"
...
enhanced_likely_results <- data.frame(
  ...
  Incentive_Created = c(
    ...
    "Districts with 'enhanced teacher incentive allotment systems' receive 1.1x multiplier on all funding",
    "State provides grants and technical assistance for implementing teacher designation systems",
    "State contracts for liability insurance and rights/duties assistance for classroom teachers",
    ...
    "2025-26 mandate: Districts must increase teacher salaries by at least the per-teacher allotment",
    "Enhanced systems must implement performance-based compensation with differentiated schedules",
    "Prohibition on across-the-board salary increases (except inflation adjustments)",
    "Enhanced systems must place highly effective teachers at high-needs campuses",
    "Additional state aid for districts that lose recapture status due to adjustments"
  ),
  ...
  Intended_Consequence = c(
    ...
    "Mid-career teachers focus on exceeding performance standards",
    "Early-career teachers work toward meeting recognized teacher criteria",
    "Creates entry-level incentive for newer teachers to engage with performance systems",
    "Teachers pursue National Board Certification",
    "Districts implement comprehensive evaluation systems and strategic teacher placement",
    "Smaller districts adopt teacher designation systems; regional partnerships form",
    "Teachers feel more secure; reduced attrition due to legal concerns",
    "Teachers join professional organizations and utilize support services",
    "Small districts focus on retaining mid-career teachers",
    "Small districts prioritize keeping experienced teachers",
    "Large districts implement targeted retention strategies",
    "Large districts balance retention funds with existing pay scales",
    "All districts provide immediate salary increases",
    "Districts move toward merit-based pay systems",
    "Administrators use performance metrics to justify salary increases",
    "Experienced teachers work at challenging schools with additional support",
    "Districts near recapture thresholds have reduced financial pressure"
  ),
  ...
  Likely_Result = c(
    ...
    "A, B, D, E", # Exemplary teachers: intrinsic→extrinsic, money focus, people as problem, competition
    ...
    "A, B", # Board Certified: intrinsic→extrinsic, money focus
    ...
    "I", # Support services: tampering with systems
    ...
    "A, B, D, E, F, J", # Performance compensation: intrinsic→extrinsic, money focus, people as problem, competition, individual focus, career problems
    "A, B, D, F, J", # No across-board increases: intrinsic→extrinsic, money focus, people as problem, individual focus, career problems
    "B, D, G", # High-needs placement: money focus, people as problem, reduced local control
    "K, N" # Funding formula: tax burden, unsustainable obligations
  )
)
...
enhanced_main_table <- datatable(
  ...
  formatStyle(
    ...
    backgroundColor = styleEqual(
      c("Teacher Designation System", "Enhanced System Bonuses", "Grant and Technical Assistance",
        "Teacher Support Services", "Teacher Retention - Small Districts", "Teacher Retention - Large Districts",
        "Salary Requirements", "Performance-Based Compensation", "High-Needs Campus Incentives",
        "Funding Formula Adjustments"),
...
key_findings <- data.frame(
  ...
  Description = c(
    "Code A (intrinsic to extrinsic motivation) and Code B (money as primary motivation) appear most frequently",
    "Financial incentives consistently shift focus from educational mission to monetary rewards",
    "Code E (decreased collaboration) appears in competitive incentive structures across multiple policy areas",
    "Code F (focus on individual teachers vs system improvement) dominates teacher designation and performance systems",
    "Code L (administrative/bureaucratic burdens) appears consistently across all major policy categories",
    "Teacher Designation System and Performance-Based Compensation show the most negative result codes per incentive"
  )
)
